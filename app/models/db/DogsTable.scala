package models.db
// AUTO-GENERATED Slick data model for table Dogs
trait DogsTable {
  ...
  /** Entity class storing rows of table Dogs
   *  @param dogId Database column DOG_ID SqlType(INT), AutoInc, PrimaryKey
  ...
  /** Collection-like TableQuery object for table Dogs */
  lazy val Dogs = new TableQuery(tag => new Dogs(tag))
}
