...
trait ArchiveDogsTable {
  ...
  case class ArchiveDogsRow(dogId: Int, dogName: String, sex: String, breed: String, colour: String, hair: String, bDate: Option[java.sql.Date], estimated: Boolean, marm: Int, chip: String, bookNbr: String, befPlace: String, befDate: Option[java.sql.Date], befCond: String, charact: String, ivDate: Option[java.sql.Date], iv: Boolean = false, status: String, ownerId: Int, adoptDate: Option[java.sql.Date], dDate: Option[java.sql.Date], comment: String, web: String)
  /** GetResult implicit for fetching ArchiveDogsRow objects using plain SQL queries */
  implicit def GetResultArchiveDogsRow(implicit e0: GR[Int], e1: GR[String], e2: GR[Option[java.sql.Date]], e3: GR[Boolean]): GR[ArchiveDogsRow] = GR{
    prs => import prs._
    ArchiveDogsRow(<<[Int], <<[String], <<[String], <<[String], <<[String], <<[String], <<[Option[java.sql.Date]], <<[Boolean], <<[Int], <<[String], <<[String], <<[String], <<[Option[java.sql.Date]], <<[String], <<[String], <<[Option[java.sql.Date]], <<[Boolean], <<[String], <<[Int], <<[Option[java.sql.Date]], <<[Option[java.sql.Date]], <<[String], <<[String])
  }
